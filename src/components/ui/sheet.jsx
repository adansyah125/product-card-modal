...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background p-0 shadow-lg",
  {
    variants: {
      side: {
        ...
        left: "inset-y-0 left-0 h-full w-full border-r sm:max-w-sm data-[state=open]:animate-slide-in-from-left data-[state=closed]:animate-slide-out-to-left",
        right:
          "inset-y-0 right-0 h-full w-full border-l sm:max-w-sm data-[state=open]:animate-slide-in-from-right data-[state=closed]:animate-slide-out-to-right",
      },
    },
    defaultVariants: {
      side: "right",
